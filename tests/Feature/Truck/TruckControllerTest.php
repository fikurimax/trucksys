...
class TruckControllerTest extends TestCase
{
    ...
    public function test_register()
    {
        ...
        $response = $this->actingAs($user)->call('POST', '/vehicle/save', [
            ...
            'nomor_rangka' => 'MSAF093325JS',
            'nomor_mesin' => 'AF3905235',
            'warna_tnkb' => 'PUTIH',
            'bahan_bakar' => 'BENSI',
            'tahun_registrasi' => '124/2141/DGF/12',
            'nama_pemilik' => 'SAHRUJI',
            'alamat_pemilik' => 'JL. ALAMAT',
            'nomor_stnk' => '02921412/FD',
            'masa_berlaku_pajak_kendaraan' => '26-01-2002',
            'kode_lokasi_pada_stnk' => 'JAKARTA BARAT',
